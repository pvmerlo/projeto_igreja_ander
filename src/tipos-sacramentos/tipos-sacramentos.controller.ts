...
export class TiposSacramentosController {
  constructor(private readonly tiposSacramentosService: TiposSacramentosService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateTiposSacramentoDto: UpdateTiposSacramentoDto) {
